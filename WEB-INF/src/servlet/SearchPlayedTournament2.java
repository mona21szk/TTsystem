...
import control.PlayedTournament2Manager;

	//HttpServletを継承することで、このクラスはServletとして、働くことができる
	public class SearchPlayedTournament2 extends HttpServlet{
	...
	*/
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		//  PlayedTournament2Managerオブジェクトの生成
		PlayedTournament2Manager manager = new PlayedTournament2Manager();

		//  出場大会の検索
		playedtournament = manager.searchPlayedTournament2(playedtournament);
		...
		getServletContext().getRequestDispatcher("/jsp/showPlayedTournament2.jsp").forward(request, response);
		}
	}
	}
}